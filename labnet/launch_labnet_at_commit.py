...
NODE_SETTINGS_PATH = f'{ROOT_PATH}/massa-node/src/settings.rs'
CONSENSUS_SETTINGS_PATH = f'{ROOT_PATH}/massa-consensus/src/settings.rs'
...
labnet_user = "XXXXXXXXXXXXXX"
labnet_pwd = "XXXXXXXXXXXXXX"
servers = {
   "labnet0": {
       "ip": "XXXXXXXXXXXXXX",
...
if __name__ == "__main__":
    ...
    with open(CONSENSUS_SETTINGS_PATH, 'r') as f:
        content = f.read()
    ...
    with open(CONSENSUS_SETTINGS_PATH, 'w') as f:
        content = f.write(content)
